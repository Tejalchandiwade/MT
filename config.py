...
def get_arguments():
    ...
    parser.add_argument('--attention_type',type=str, help="image quality improvement (SE_with_ResNet|self_attn_with_ResNet|CBAM_with_ResNet|ResNet)", default="ResNet")
